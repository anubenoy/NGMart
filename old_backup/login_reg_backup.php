...
<body>
    ...
    <div class="content_login" id="pages">
        ...
        <div class="container" id="page1" >
            <center>
                <form action="php/login.php" method="POST" id="login_form">
                    ...
                    <input type="text" name="login_email" id="login_email" placeholder="Email_ID" required><br>
                    <input type="password" name="login_pass" id="login_pass" placeholder="Password" required><br>
        ...
        <!-- ------------------------------page 3 -------------------------- -->
        <div class="container" id="page3" style="visibility: hidden;">
            <center>
            <form action="php/seller_reg.php" method="POST" enctype="multipart/form-data" id="sell_reg" >
              <h1 style="color:rgb(65,178,151);">Create an Account</h1>
                <div>
                    <!-- name -->
                    <div>
                        <input type="text" id="name_3" name="name" onchange="checkName('err3_1','name_3')" placeholder="Name" required >
