...
if($result=mysqli_query($con,$sql))
	{ 
        ...
        if($row['image']<>$file)
        {
           $sql2="update product_seller_tbl set image='$file' where ps_id=$ps_id";
           mysqli_query($con,$sql2);
           $file_path='../../images/'.$file;
           move_uploaded_file($_FILES["file"]["tmp_name"], $file_path);   
       }

       $sql1="update product_seller_tbl set price='$price', qty='$qty', short_desc='$desc' where ps_id=$ps_id";
