	...
	<div class="topbar_bottom">
		<center>
			...
			if($result=mysqli_query($con,$sql))
			{
				...
				{
					?>
					<a href="index.php?id=<?php echo $row['id'] ?>" <?php if(isset($_GET['id'])){ if($row['id']==$_GET['id']) echo "class=active"; } ?> > <?php echo $row['categories'] ?> </a>
...
<div class="container_body">
	<center>
		<div class="bdy">
			...
			$sql="select p.*,ps.* from product_tbl as p,product_seller_tbl as ps where p.id=ps.product_id";
...
<div class="container_body">
	<center>
		<div class="bdy">
			...
			$sql="select p.*,ps.* from product_tbl as p,product_seller_tbl as ps where p.id=ps.product_id and p.categories_id=$id";
