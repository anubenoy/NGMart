...
<body>
    <div class="topblack">
        <div class="leftblock">
            <p>For enquiry call 911 | email on <a style="color:rgba(255, 255, 255, 0.851);"
                    href="mailto:admin@gmail.com"> admin@gmail.com </a></p>
        </div>
    ...
    <div class="topbargreen">
        ...
        <div class="topgreen_right">
            ...
            <a href="php/cust/wishlist.php" style="margin-right:20px">Wishlist
                <sup id="wss"
                    style="background-color:red;border-radius:100%; padding:2px 4px;"><?php echo $rown['count2']?>
                </sup>
            </a>
            <a href="php/cust/cart.php" style="margin-right:20px">Cart
                <sup id="ss"
                    style="background-color:red;border-radius:100%; padding:2px 4px;"><?php echo $row['count']?> </sup>
            </a>
    ...
    <div class="topbar_bottom">
        <center>
            ...
            <a href="index.php?id=<?php echo $row['id'] ?>"
                <?php if(isset($_GET['id'])){ if($row['id']==$_GET['id']) echo "class=active"; } ?>>
...
<!-- 
use alt+ctrl+f to fromatt code -->